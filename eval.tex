...
\wil{It's a bit tricky that we pre-segmented the foreground elements for \interface, since ostensibly, the setup for our system could involve this segmentation step. I guess we could justify this by saying that we wanted to make the overall task time reasonable? Or am I misunderstanding the description?}
